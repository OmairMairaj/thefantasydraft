        ...
        <section className="intro-section text-white py-16">
            <div className=" flex flex-col md:flex-row items-center justify-between gap-12 ">
                ...
                <div className="md:w-1/2">
                    <h2 className={`text-3xl md:text-5xl font-bold italic text-orange-500 mb-6 ${exo2.className}`}>
                    ...
                    <a href="/how-to-play" className="button mt-10 relative px-6 md:px-8 lg:px-12 py-2 rounded-full text-white text-center font-bold text-sm md:text-base lg:text-lg border-2 hover:bg-[#FF8A00] cursor-pointer">
