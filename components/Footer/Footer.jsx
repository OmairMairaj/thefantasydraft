            ...
            <div className="flex flex-col sm:flex-row sm:justify-between md:items-center sm:space-y-1">
                ...
                <div className="flex md:justify-start px-4 md:px-0 items-center">
                    <Image
                        ...
                        width={100}
                        height={100}
                        className="object-cover cursor-pointer w-16 sm:w-20 md:w-20 lg:w-24 xl:w-28"
                ...
                <div className="footer-links px-6 grid grid-cols-2 gap-x-2 md:gap-x-8 lg:gap-x-2 gap-y-1 lg:flex lg:space-x-8 text-white lg:text-center text-sm sm:text-base xl:text-lg mt-4">
