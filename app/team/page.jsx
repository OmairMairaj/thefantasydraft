    ...
    const renderSkeletons = (required, chosenCount) => {
        ...
        return Array.from({ length: Math.max(0, required - chosenCount) }).map((_, index) => (
            ...
            >
                ...
                <p className="text-sm mt-4 w-full bg-gray-700 h-4 animate-pulse" />
            </div>
        ));
    };
            ...
            <div className="grid grid-cols-5 gap-6 w-full">
                ...
                <div className="col-span-3 bg-[#1C1C1C] rounded-xl p-6 relative">
                    ...
                    <div className="rounded-lg flex flex-col items-center w-full ">
                        {/* Rank */}
                        {/* <div className="absolute right-6 top-6 text-lg font-semibold flex items-center ">
                            Rank: <span className="text-4xl font-bold px-2">1st</span>
                        </div> */}
            ...
            {/* {pitchView ? (
                    <div className="grid grid-cols-4 gap-4">
                        {players.map((player, index) => (
                            <div
                                key={player.id}
                                className="flex flex-col items-center bg-[#2C2C2C] p-4 rounded-lg"
                            >
                                <img
                                        ...
                                        <Draggable key={player.id} draggableId={player.id} index={index}>
                                            {(provided) => (
                                                <li
                                                    ...
                                                    ref={provided.innerRef}
                                                    className="bg-[#2C2C2C] p-4 rounded-lg flex justify-between items-center"
                                                >
                                                    ...
                                                    <button className="bg-[#FF8A00] px-4 py-2 rounded-lg">
                                                        Sub/Unsub
                                                    </button>
                                                </li>
                                            )}
