                  ...
                  >
                    <div className="rounded-2xl bg-white/10 hover:scale-105 transition-transform flex flex-col items-center p-6 cursor-pointer">
                      ...
                      <div className="text-gray-300 text-sm mt-1">
                        {sl.leagues?.length || 0} league
                        {sl.leagues?.length === 1 ? "" : "s"}
                      </div>
                    </div>
                  </div>
                ))}
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 ">
          ...
          >
            ...
            <input
              ...
              className={`w-full p-1 md:p-2 bg-[#1b3546] text-white rounded-lg mb-1 text-center text-sm xl:text-base focus:placeholder-transparent focus:outline-none  ${
                inputError
            ...
            <div className="flex justify-between mt-4">
              <button
                className={`px-4 sm:px-6 xl:px-8 py-1 md:py-2 text-sm xl:text-base rounded-xl shadow-md ${
                  !inputSuperLeagueName
