                                    ...
                                    <div className="flex items-center w-full space-x-4">
                                        ...
                                        <div className="text-white flex items-center justify-center font-bold text-center overflow-hidden">
                                            {selectedTeam?.team_image_path ? (
                                                <img src={selectedTeam.team_image_path} alt="Team Logo" className="w-32 h-32 object-cover" />
                                            ) : (
                                                <img src={'/images/placeholder.png'} alt="Team Logo" className="p-7 w-32 h-32 object-cover border border-gray-600 rounded-full" />
                                            )}
                                        </div>
