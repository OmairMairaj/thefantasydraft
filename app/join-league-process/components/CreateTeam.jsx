...
const CreateTeam = ({ onNext, onBack }) => {
    const savedData = JSON.parse(sessionStorage.getItem('joinLeagueTeamData')) || {};
    ...
    const handleSubmit = () => {
        ...
        sessionStorage.setItem('joinLeagueTeamData', JSON.stringify({ teamName, teamLogo, groundName, selectedGround }));
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8">
                    <div className="flex flex-col space-y-6 max-w-sm lg:max-w-lg">
                        ...
                        <div className="flex flex-col">
                            <label className="font-bold text-sm md:text-lg mb-2" htmlFor="team-name">Team Name</label>
                            <input
                                id="team-name"
                                type="text"
                                value={teamName}
                        ...
                        {/* Ground Name Input */}
                        <div className="flex flex-col">
                            <label className="font-bold text-sm md:text-lg mb-2" htmlFor="ground-name">Ground Name</label>
                            <input
                                id="ground-name"
                                type="text"
                                value={groundName}
                    ...
                    <div className="flex flex-col space-y-1">
                        <label className="font-bold text-sm md:text-lg" htmlFor="team-logo">Team Logo</label>
