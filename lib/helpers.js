...
export const filterPlayersForTransfer = async (allPlayers, draftID, teamID) => {
...
export const setInTeam = async (draft) => {
    ...
    teams.map((team) => {
        ...
        // Assigning this team to all historical squad array objects
        let gameweeks = GameWeek.find({});
        team.history = [];
